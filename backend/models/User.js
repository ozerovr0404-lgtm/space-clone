...
export class User {
    constructor({ id, first_name, last_name, middle_name, login, password, is_active, created_at }) {
        this.id = id;
    ...
    static async create({ first_name, last_name, middle_name, login, password, is_active = true }) {
